      ...
      <div class="row">
        <div class="col-xs-12">
          <div class='chrome-mockup video-holder col-xs-12'>
            <video id="chrome-video-el-projecte" class="video-js video" no-controls autoplay loop preload="auto"
            poster="<?= get_template_directory_uri(); ?>/dist/videos/memoria-viva/chrome-video-el-projecte.jpg" data-setup="{}">
            <source src="<?= get_template_directory_uri(); ?>/dist/videos/memoria-viva/chrome-video-el-projecte.mp4" type='video/mp4'>
              <source src="<?= get_template_directory_uri(); ?>/dist/videos/memoria-viva/chrome-video-el-projecte.webm" type='video/webm'>
                <p class="vjs-no-js">
                  To view this video please enable JavaScript, and consider upgrading to a web browser that
                  <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a>
                </p>
